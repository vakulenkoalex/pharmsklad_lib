...
Функция ВызватьМетод(Знач HTTPМетод, Знач HTTPЗапрос)
	...
	Логгер.Отладка("HTTPЗапрос", УникальныйКодЗапроса, СериализацияЗапроса);
	
	Попытка
		HTTPОтвет = HTTPСоединение.ВызватьHTTPМетод(HTTPМетод, HTTPЗапрос);
	Исключение
		Логгер.Ошибка("HTTPЗапрос", УникальныйКодЗапроса, СериализацияЗапроса);
	...
	Логгер.Отладка("HTTPОтвет", УникальныйКодЗапроса, СериализацияОтвета(HTTPОтвет));
