...
Процедура Старт(Знач ПараметрыЗапуска,
	...
	МетодДляЗапуска = "РаботаВБезопасномРежиме.ВыполнитьМетодКонфигурации";
...
Процедура ПроверкаЗавершенияЗаданий(ЗапущенныеЗадания, СообщенияФоновыхЗаданий, ЗаданияЗавершенныеАварийно)
	...
	Для Каждого Идентификатор Из ЗапущенныеЗадания Цикл
		...
		Если ТекущееЗадание.Состояние = СостояниеФоновогоЗадания.ЗавершеноАварийно Или ТекущееЗадание.Состояние = СостояниеФоновогоЗадания.Отменено Тогда
