...
Перем ГенераторТестовыхДанных; // Контекст плагина создания тестовый данных
...
Процедура ПередЗапускомТеста() Экспорт
	...
	МенеджерЗаписи.ЗначениеПараметра = КаталогВременныхФайлов() + "error.log";
...
Процедура Тест_СложныеДанныеИзЛогаСохраняютсяВJson() Экспорт
	...
	Попытка
		...
		Данные = фмИнтеграцияКлиентСервер.UnJSON(Лог.Data);
	Исключение
		БылаОшибка = Истина;
	КонецПопытки;
